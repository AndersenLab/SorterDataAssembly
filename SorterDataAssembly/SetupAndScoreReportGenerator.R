...
writeLines("Within your root directory, you should be able to access your source functions, all data, and desired output location.
...
#changed file in load("~/Dropbox/Biosort/Scripts and functions/bubbleSVMmodel_noProfiler.RData")
